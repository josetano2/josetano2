...
var ne=(h=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(h,{get:(e,t)=>(typeof require<"u"?require:e)[t]}):h)(function(h){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+h+'" is not supported')});import Ge from"ignore";import b from"chalk";import xe from"find-config";import H from"fs";import Ze from"glob";import w from"lodash";import B from"path";import m from"process";import Se from"util";var O=class extends Error{};import{sortClasses as te}from"@shufo/tailwindcss-class-sorter";import Ne from"aigle";import _ from"detect-indent";import{sortAttributes as ve}from"html-attribute-sorter";import E from"js-beautify";import i from"lodash";import*as Xe from"vscode-textmate";import Je from"xregexp";function Ie(h){return h.split(`
`)}function Re(h){return h.trim().startsWith("*")}function Ee(h){return h.length>1}function De(h){return` ${h}`}function re(h){let e=Ie(h);if(!Ee(e))return h;let t=!1;return e.map((r,s)=>{if(s===0||t)return r;if(!Re(r))return t=!0,r;let a=r.trim();return De(a)}).join(`
`)}var Le={defaultPrintWidth:120},V=Le;import W from"lodash";var A="@",P=["@alert","@pushonce","@push","@slot","@switch","@unless","@verbatim","@prependonce","@prepend","@once","@error","@empty","@guest","@isset","@permission","@permissions","@canany","@cannot","@can","@role","@hasrole","@hasanyrole","@hasallroles","@unlessrole","@hasexactroles","@if","@production","@env","@while","@auth","@forelse","@for","@foreach","@php","@component","@section","@customdirective"],ie=W.map(P,h=>h.substring(1)),I=["@endalert","@endpushonce","@endpush","@endslot","@endswitch","@endunless","@endverbatim","@show","@stop","@endprependonce","@endprepend","@endonce","@enderror","@append","@overwrite","@endempty","@endguest","@endisset","@endpermission","@endpermissions","@endcanany","@endcannot","@endcan","@endrole","@endhasrole","@endhasanyrole","@endhasallroles","@endunlessrole","@endhasexactroles","@endif","@endproduction","@endenv","@endwhile","@endauth","@endforelse","@endforeach","@endfor","@endphp","@endcomponent","@endsection","@endcustomdirective"],R=["@elseenv","@elseif","@elsecanany","@elsecannot","@elsecan","@else","@elsecustomdirective"],K={"@section":2,"@push":2,"@prepend":2,"@slot":2},se=["@forelse","@if"],Q=["@empty"],ae=["@default"],k=["@forelse","@if","@for","@foreach","@while","@sectionmissing","@case"],z=["@endforelse","@endif","@endforeach","@endfor","@endwhile","@break"],G=["@button","@class","@include","@disabled","@checked","@json"],F=["@set","@json","@selected","@checked","@disabled","@php","@include","@includeif","@includewhen","@includeunless","@includefirst","@button","@class","@props","@aware"],oe=["@if","@while","@case","@isset","@empty","@elseif","@component","@hassection","@unless"],N=["@hassection"],X=["@charset","@color-profile","@counter-style","@font-face","@font-feature-values","@import","@keyframes","@media","@namespace","@page","@property","@supports"];function le(h,e){return W.filter(h.tokens,t=>{let n=e.substring(t.startIndex,t.endIndex).trim();return W.includes(P,n)||W.includes(I,n)}).length>=2}var y="\\(((?:[^)(]+|\\((?:[^)(]+|\\((?:[^)(]+|\\((?:[^)(]+|\\([^)(]*\\))*\\))*\\))*\\))*)\\)?";import Ae from"lodash";function ce(h){let e=["@unless"];return Ae.replace(h,new RegExp(`(?<!@)(${e.join("|")})\\s*${y}`,"gi"),(t,n,r)=>`${n} (${r})`)}import x from"lodash";import ke from"fs";import Fe from"os";import Z from"chalk";import q from"prettier/standalone.js";import Y from"@prettier/plugin-php/standalone.js";import ft from"detect-indent";var f=h=>{let e={get(){return null}};return x.isUndefined(h)||x.isNull(h)?e:h};async function J(h){return new Promise((e,t)=>{ke.readFile(h,(n,r)=>n?t(n):e(r))})}function j(h){return h?h.split(/\r\n|\n|\r/):""}var L=1e3,he={noPhpSyntaxCheck:!1,printWidth:L,trailingCommaPHP:!0,phpVersion:"8.1",noSingleQuote:!1};function D(h,e={}){let t={...he,...e};try{return q.format(h.replace(/\n$/,""),{parser:"php",printWidth:1e3,singleQuote:!t.noSingleQuote,phpVersion:t.phpVersion,trailingCommaPHP:t.trailingCommaPHP,plugins:[Y]})}catch(n){if(t.noPhpSyntaxCheck===!1)throw n;return h}}function S(h,e={}){let t={...he,...e};try{return q.format(`<?php echo ${h} ?>`,{parser:"php",printWidth:t.printWidth,singleQuote:!t.noSingleQuote,phpVersion:t.phpVersion,trailingCommaPHP:t.trailingCommaPHP,plugins:[Y]}).replace(/<\?php echo (.*)?\?>/gs,(n,r)=>r.trim().replace(/;\s*$/,""))}catch(n){if(t.noPhpSyntaxCheck===!1)throw n;return h}}function pe(h){let e=`<?php tmp_func${h}; ?>`,{ast:t}=q.__debug.parse(e,{parser:"php",phpVersion:"8.0",plugins:[Y]});try{return t.children[0].expression.arguments.length||0}catch{return 0}}function de(h){return Promise.all(x.map(h,async e=>{process.stdout.write(`path: ${Z.bold(e.path)}:${e.line}
`),process.stdout.write(Z.red(`--${e.original}
`)),process.stdout.write(Z.green(`++${e.formatted}
`))}))}function ue(h,e,t){let n=x.map(e,(r,s)=>x.isEmpty(r)||r===t[s]?null:{path:h,line:s+1,original:r,formatted:t[s]});return x.without(n,null)}async function Te(h,e){let t=x.without(P,"@switch","@forelse","@php").join("|"),n=new RegExp(`(?!\\/\\*.*?\\*\\/)(${t})(\\s*?)${y}`,"gmi");return new Promise(r=>r(h)).then(r=>x.replace(r,n,(s,a,l,o)=>D(`<?php ${a.substr("1")}${l}(${o}) ?>`,e).replace(/<\?php\s(.*?)(\s*?)\((.*?)\);*\s\?>\n/gs,(c,d,p,u)=>`@${d.trim()}${p}(${u.trim()})`).replace(/([\n\s]*)->([\n\s]*)/gs,"->").replace(/,\)$/,")").replace(/(?:\n\s*)* as(?= (?:&{0,1}\$[\w]+|list|\[\$[\w]+))/g," as"))).then(r=>D(r,e))}async function ge(h,e){return Te(h,e)}function me(h){let e=x.without(k,"@case"),t=x.without(z,"@break");return new Promise(n=>n(h)).then(n=>{let r=new RegExp(`(${e.join("|")})([\\s]*?)${y}`,"gis");return x.replace(n,r,(s,a,l,o)=>`<beautifyTag start="${a}${l}" exp="^^^${x.escape(o)}^^^">`)}).then(n=>{let r=new RegExp(`(?!end=".*)(${t.join("|")})(?!.*")`,"gi");return x.replace(n,r,(s,a)=>`</beautifyTag end="${a}">`)})}function fe(h){return new Promise(e=>e(h)).then(e=>x.replace(e,/<beautifyTag.*?start="(.*?)".*?exp=".*?\^\^\^(.*?)\^\^\^.*?"\s*>/gs,(t,n,r)=>`${n}(${x.unescape(r)})`)).then(e=>x.replace(e,/<\/beautifyTag.*?end="(.*?)"\s*>/gs,(t,n)=>`${n}`))}var Oe=["/\\*\\* phptag_start \\*\\*/","/\\*\\* end_phptag \\*\\*/","/\\*escaped\\*/","__BLADE__;","/\\* blade_comment_start \\*/","/\\* blade_comment_end \\*/","/\\*\\*\\*script_placeholder\\*\\*\\*/","blade___non_native_scripts_","blade___scripts_","blade___html_tags_","beautifyTag","@customdirective","@elsecustomdirective","@endcustomdirective","x-slot --___\\d+___--","___attrs_+\\d+___"];function ye(h){if(new RegExp(Oe.join("|")).test(h))throw new Error(["Can't format blade: something goes wrong.","Please check if template is too complicated or not. Or simplify template might solves issue."].join(`
`));return h}function ee(h){return h.replace(/\$/g,"$$$$")}function _e(h){switch(h){case"LF":return`
`;case"CRLF":return`\r
`;default:return Fe.EOL}}import{promises as je}from"fs";import He from"lodash";import*as M from"vscode-oniguruma";import We from"path";var U=class{constructor(e,t){return(async()=>{var n;return this.vsctm=(n=e.default)!=null?n:e,this.oniguruma=t||(M==null?void 0:M.default)||M,await this.loadWasm(),this})()}async loadWasm(){var t;let e=await je.readFile(ne.resolve("vscode-oniguruma/release/onig.wasm"));if(await((t=this.oniguruma)==null?void 0:t.loadWASM(e.buffer)),!this.initCalled){try{this.oniguruma.loadWASM(e.buffer)}catch{this.initCalled=!0}this.initCalled=!0}}createRegistry(){return this.registry=new this.vsctm.Registry({loadGrammar:e=>e==="text.html.php.blade"?J(We.resolve(__dirname,"../syntaxes/blade.tmLanguage.json")).then(t=>this.vsctm.parseRawGrammar(t.toString(),"./blade.tmLanguage.json")):null,onigLib:Promise.resolve({createOnigScanner:e=>new this.oniguruma.OnigScanner(e),createOnigString:e=>new this.oniguruma.OnigString(e)})}),this.registry}tokenizeLines(e,t){return He.map(e,n=>{var r;return t.tokenizeLine(n,(r=this.vsctm)==null?void 0:r.INITIAL)})}};var T=class{constructor(e){this.options={noPhpSyntaxCheck:!1,trailingCommaPHP:!e.noTrailingCommaPhp,printWidth:e.wrapLineLength||V.defaultPrintWidth,...e},this.vsctm=f(this.options).vsctm||Xe,this.oniguruma=f(this.options).oniguruma,this.indentCharacter=f(this.options).useTabs?"	":" ",this.indentSize=f(this.options).indentSize||4,this.wrapLineLength=f(this.options).wrapLineLength||V.defaultPrintWidth,this.wrapAttributes=f(this.options).wrapAttributes||"auto",this.currentIndentLevel=0,this.shouldBeIndent=!1,this.isInsideCommentBlock=!1,this.stack=[],this.ignoredLines=[],this.curlyBracesWithJSs=[],this.rawBlocks=[],this.rawPhpTags=[],this.inlineDirectives=[],this.conditions=[],this.inlinePhpDirectives=[],this.rawPropsBlocks=[],this.bladeDirectives=[],this.bladeDirectivesInStyle=[],this.bladeComments=[],this.phpComments=[],this.bladeBraces=[],this.rawBladeBraces=[],this.nonnativeScripts=[],this.scripts=[],this.htmlAttributes=[],this.xData=[],this.xInit=[],this.htmlTags=[],this.templatingStrings=[],this.stringLiteralInPhp=[],this.shorthandBindings=[],this.componentAttributes=[],this.customDirectives=[],this.directivesInScript=[],this.unbalancedDirectives=[],this.escapedBladeDirectives=[],this.xSlot=[],this.result=[],this.diffs=[],this.defaultPhpFormatOption={noPhpSyntaxCheck:this.options.noPhpSyntaxCheck,printWidth:this.wrapLineLength},this.endOfLine=_e(f(this.options).endOfLine)}formatContent(e){return new Promise(t=>t(e)).then(t=>this.preserveIgnoredLines(t)).then(t=>this.preserveNonnativeScripts(t)).then(t=>this.preserveCurlyBraceForJS(t)).then(t=>this.preserveRawPhpTags(t)).then(t=>this.preserveEscapedBladeDirective(t)).then(t=>ge(t,this.options)).then(t=>this.preserveBladeComment(t)).then(t=>this.preserveBladeBrace(t)).then(t=>this.preserveRawBladeBrace(t)).then(t=>this.preserveConditions(t)).then(t=>this.preservePropsBlock(t)).then(t=>this.preserveInlinePhpDirective(t)).then(t=>this.preserveInlineDirective(t)).then(t=>this.preserveBladeDirectivesInScripts(t)).then(t=>this.preserveBladeDirectivesInStyles(t)).then(t=>this.preserveCustomDirective(t)).then(t=>this.preserveUnbalancedDirective(t)).then(t=>this.breakLineBeforeAndAfterDirective(t)).then(async t=>(this.bladeDirectives=await this.formatPreservedBladeDirectives(this.bladeDirectives),t)).then(t=>this.preserveScripts(t)).then(t=>this.sortTailwindcssClasses(t)).then(t=>this.formatXInit(t)).then(t=>this.formatXData(t)).then(t=>this.preservePhpBlock(t)).then(t=>this.sortHtmlAttributes(t)).then(t=>this.preserveHtmlAttributes(t)).then(t=>this.preserveComponentAttribute(t)).then(t=>this.preserveShorthandBinding(t)).then(t=>this.preserveXslot(t)).then(t=>this.preserveHtmlTags(t)).then(t=>this.formatAsHtml(t)).then(t=>this.formatAsBlade(t)).then(t=>this.restoreHtmlTags(t)).then(t=>this.restoreXslot(t)).then(t=>this.restoreShorthandBinding(t)).then(t=>this.restoreComponentAttribute(t)).then(t=>this.restoreHtmlAttributes(t)).then(t=>this.restorePhpBlock(t)).then(t=>this.restoreXData(t)).then(t=>this.restoreXInit(t)).then(t=>this.restoreScripts(t)).then(t=>this.restoreUnbalancedDirective(t)).then(t=>this.restoreCustomDirective(t)).then(t=>this.restoreBladeDirectivesInStyles(t)).then(t=>this.restoreBladeDirectivesInScripts(t)).then(t=>this.restoreInlineDirective(t)).then(t=>this.restoreInlinePhpDirective(t)).then(t=>this.restoreConditions(t)).then(t=>this.restoreRawBladeBrace(t)).then(t=>this.restoreBladeBrace(t)).then(t=>this.restoreBladeComment(t)).then(t=>this.restoreEscapedBladeDirective(t)).then(t=>this.restoreRawPhpTags(t)).then(t=>this.restoreCurlyBraceForJS(t)).then(t=>this.restoreNonnativeScripts(t)).then(t=>this.restoreIgnoredLines(t)).then(t=>ce(t)).then(t=>ye(t))}formatAsHtml(e){let t={indent_size:f(this.options).indentSize||4,wrap_line_length:f(this.options).wrapLineLength||120,wrap_attributes:f(this.options).wrapAttributes||"auto",wrap_attributes_min_attrs:f(this.options).wrapAttributesMinAttrs,indent_inner_html:f(this.options).indentInnerHtml||!1,end_with_newline:f(this.options).endWithNewline||!0,max_preserve_newlines:f(this.options).noMultipleEmptyLines?1:void 0,extra_liners:f(this.options).extraLiners,css:{end_with_newline:!1},eol:this.endOfLine},n=new Promise(r=>r(e)).then(r=>me(r)).then(r=>E.html_beautify(r,t)).then(r=>fe(r));return Promise.resolve(n)}async sortTailwindcssClasses(e){return this.options.sortTailwindcssClasses?i.replace(e,/(?<=\s+(?!:)class\s*=\s*([\"\']))(.*?)(?=\1)/gis,(t,n,r)=>{if(i.isEmpty(r))return r;if(this.options.tailwindcssConfigPath){let s={tailwindConfigPath:this.options.tailwindcssConfigPath};return te(r,s)}if(this.options.tailwindcssConfig){let s={tailwindConfig:this.options.tailwindcssConfig};return te(r,s)}return te(r)}):e}async preserveIgnoredLines(e){return i.chain(e).replace(/(^(?<!.+)^{{--\s*blade-formatter-disable\s*--}}.*?)([\r\n]*)$(?![\r\n])/gis,(t,n,r)=>this.storeIgnoredLines(`${n}${r.replace(/^\n/,"")}`)).replace(/(?:({{--\s*?blade-formatter-disable\s*?--}}|<!--\s*?prettier-ignore-start\s*?-->|{{--\s*?prettier-ignore-start\s*?--}})).*?(?:({{--\s*?blade-formatter-enable\s*?--}}|<!--\s*?prettier-ignore-end\s*?-->|{{--\s*?prettier-ignore-end\s*?--}}))/gis,t=>this.storeIgnoredLines(t)).replace(/(?:{{--\s*?blade-formatter-disable-next-line\s*?--}}|{{--\s*?prettier-ignore\s*?--}}|<!--\s*?prettier-ignore\s*?-->)[\r\n]+[^\r\n]+/gis,t=>this.storeIgnoredLines(t)).value()}async preserveCurlyBraceForJS(e){return i.replace(e,/@{{(.*?)}}/gs,(t,n)=>this.storeCurlyBraceForJS(n))}async preservePhpBlock(e){return this.preserveRawPhpBlock(e)}async preservePropsBlock(e){return i.replace(e,/@props\(((?:[^\\(\\)]|\([^\\(\\)]*\))*)\)/gs,(t,n)=>this.storeRawPropsBlock(n))}async preserveRawPhpBlock(e){return i.replace(e,/(?<!@)@php(.*?)@endphp/gs,(t,n)=>this.storeRawBlock(n))}async preserveHtmlTags(e){let t=["textarea","pre"];return i.replace(e,new RegExp(`<(${t.join("|")})\\s{0,1}.*?>.*?<\\/(${t.join("|")})>`,"gis"),n=>this.storeHtmlTag(n))}preserveCustomDirective(e){let t=[...i.without(P,"@unless"),...I,...R,"@unless\\(.*?\\)"].join("|"),n=i.chain([...i.without(P,"@unless","@for"),...I,...R,...F,...i.without(k,"@for"),"@unless[a-z]*\\(.*?\\)","@for\\(.*?\\)",...N,...X]).uniq().join("|").value(),r=new RegExp(`(?!(${n}))(@([a-zA-Z1-9_\\-]+))(?!.*?@end\\3)${y}.*?(?<!@end\\5)`,"gis"),s=new RegExp(`(?!(${t}))(@(unless)*([a-zA-Z1-9_\\-]+))(?!.*?\\2)(\\s|\\(.*?\\))+(.*?)(@end\\4)`,"gis"),a;return a=i.replace(e,r,l=>this.storeInlineCustomDirective(l)),a=i.replace(a,s,(l,o,c,d,p,u,g,$)=>{if(P.includes(c))return l;let v=l;return v=i.replace(v,new RegExp(`${c}(${y})*`,"gim"),C=>this.storeBeginCustomDirective(C)),v=i.replace(v,$,this.storeEndCustomDirective($)),v=i.replace(v,new RegExp(`@else${p}(${y})*`,"gim"),C=>this.storeElseCustomDirective(C)),v}),s.test(a)&&(a=this.preserveCustomDirective(a)),a}preserveInlineDirective(e){let t=new RegExp(`(<[\\w\\-\\_]+?[^>]*?)${A}(${ie.join("|")})(\\s*?)?(\\([^)]*?\\))?((?:(?!@end\\2).)+)(@end\\2|@endif)(.*?/*>)`,"gims"),n=i.replace(e,t,(r,s,a,l,o,c,d,p)=>l===void 0&&o===void 0?`${s}${this.storeInlineDirective(`${A}${a.trim()}${c.trim()} ${d.trim()}`)}${p}`:l===void 0?`${s}${this.storeInlineDirective(`${A}${a.trim()}${o.trim()}${c}${d.trim()}`)}${p}`:o===void 0?`${s}${this.storeInlineDirective(`${A}${a.trim()}${l}${c.trim()} ${d.trim()}`)}${p}`:`${s}${this.storeInlineDirective(`${A}${a.trim()}${l}${o.trim()} ${c.trim()} ${d.trim()}`)}${p}`);return t.test(n)?this.preserveInlineDirective(n):n}async preserveInlinePhpDirective(e){return i.replace(e,new RegExp(`(?!\\/\\*.*?\\*\\/)(${F.join("|")})(\\s*?)${y}`,"gmsi"),t=>this.storeInlinePhpDirective(t))}preserveBladeDirectivesInScripts(e){return i.replace(e,/(?<=<script[^>]*?(?<!=)>)(.*?)(?=<\/script>)/gis,t=>{let n=[...P,...F];if(new RegExp(n.join("|"),"gmi").test(t)===!1)return/^[\s\n]+$/.test(t)?t.trim():t;let r=F.join("|"),s=new RegExp(`(?!\\/\\*.*?\\*\\/)(${r})(\\s*?)${y}`,"gmi"),a=i.chain(I).without("@endphp"),l=t;return l=i.replace(l,s,o=>this.storeBladeDirective(S(o,{...this.options,printWidth:L}))),l=i.replace(l,new RegExp(`(${P.join("|")})\\s*?${y}`,"gis"),o=>`if ( /*${this.storeBladeDirectiveInScript(o)}*/ ) {`),l=i.replace(l,new RegExp(`(${[...R,...Q].join("|")})(?!\\w+?\\s*?\\(.*?\\))`,"gis"),o=>`/***script_placeholder***/} /* ${this.storeBladeDirectiveInScript(o)} */ {`),l=i.replace(l,new RegExp(`(${a.join("|")})`,"gis"),o=>`/***script_placeholder***/} /*${this.storeBladeDirectiveInScript(o)}*/`),l=i.replace(l,/(?<!@)@php(.*?)@endphp/gis,(o,c)=>this.storeRawBlock(c)),l=this.preserveCustomDirectiveInScript(l),l})}preserveBladeDirectivesInStyles(e){return i.replace(e,/(?<=<style[^>]*?(?<!=)>)(.*?)(?=<\/style>)/gis,t=>{let n=t,r=new RegExp(`(?!${["@end","@else",...X].join("|")})@(\\w+)\\s*?(?![^\\1]*@end\\1)${y}`,"gmi");n=i.replace(n,r,c=>`${this.storeBladeDirectiveInStyle(c)} {/* inline_directive */}`);let s=new RegExp(`(?!${["@end","@else",...X].join("|")})@(\\w+)\\s*?(${y})`,"gmi");n=i.replace(n,s,c=>`${this.storeBladeDirectiveInStyle(c)} { /*start*/`);let a=new RegExp(`(${P.join("|")})\\s*?(${y})`,"gmi");n=i.replace(n,a,c=>`${this.storeBladeDirectiveInStyle(c)} { /*start*/`);let l=new RegExp(`(${["@else\\w+",...R].join("|")})\\s*?(${y})?`,"gmi");n=i.replace(n,l,c=>`} ${this.storeBladeDirectiveInStyle(c)} { /*else*/`);let o=new RegExp(`${["@end\\w+",...I].join("|")}`,"gmi");return n=i.replace(n,o,c=>`} /* ${this.storeBladeDirectiveInStyle(c)} */`),n})}preserveCustomDirectiveInScript(e){let t=[...i.without(P,"@unless"),...I,...R,"@unless\\(.*?\\)"].join("|"),n=[...i.without(P,"@unless"),...I,...R,...F,...k,"@unless[a-z]*\\(.*?\\)",...N].join("|"),r=new RegExp(`(?!(${n}))(@([a-zA-Z1-9_\\-]+))(?!.*?@end\\3)${y}.*?(?<!@end\\5)`,"gis"),s=new RegExp(`(?!(${t}))(@(unless)*([a-zA-Z1-9_\\-]+))(?!.*?\\2)(\\s|\\(.*?\\))+(.*?)(@end\\4)`,"gis"),a;return a=i.replace(e,r,l=>this.storeInlineCustomDirective(l)),a=i.replace(a,s,(l,o,c,d,p,u,g,$)=>{if(P.includes(c))return l;let v=l;return v=i.replace(v,new RegExp(`${c}(${y})*`,"gim"),C=>`if ( /*${this.storeBladeDirectiveInScript(C)}*/ ) {`),v=i.replace(v,new RegExp(`@else${p}(${y})*`,"gim"),C=>`/***script_placeholder***/} /* ${this.storeBladeDirectiveInScript(C)} */ {`),v=i.replace(v,$,C=>`/***script_placeholder***/} /*${this.storeBladeDirectiveInScript(C)}*/`),v}),s.test(a)&&(a=this.preserveCustomDirectiveInScript(a)),a}breakLineBeforeAndAfterDirective(e){e=i.replace(e,new RegExp(`(?<=<.*?(?<!=)>)(${i.without(P,"@php").join("|")})(\\s*)${y}.*?(?=<.*?>)`,"gmis"),s=>`
${s.trim()}
...
`);return i.chain(l).map((o,c)=>c===0?o.trim():c===l.length-1?a+o:o.length===0?o:s+o).join(`
...
`)}indentComponentAttribute(e,t){if(i.isEmpty(e))return t;if(this.isInline(t))return`${t}`;if(this.isInline(t)&&/\S/.test(e))return`${t}`;let r=_(e).amount/this.indentSize,s=this.indentCharacter.repeat(r<0?0:r*this.indentSize),a=t.split(`
`);return i.chain(a).map((l,o)=>o===0?l.trim():s+l).value().join(`
...
Formatted Files: 
`)),w.each(this.formattedFiles,e=>m.stdout.write(`${b.bold(e)}
`))}printDifferences(){if(this.options.diff){if(m.stdout.write(b.bold(`
Differences: 

`)),w.filter(this.diffs,e=>e.length>0).length===0){m.stdout.write(b(`No changes found. 

`));return}w.each(this.diffs,e=>de(e))}}printErrors(){w.isEmpty(this.errors)||(m.stdout.write(b.red.bold(`
Errors: 

`)),w.each(this.errors,e=>m.stdout.write(`${Se.format(e)}
`)))}};export{Ce as BladeFormatter,T as Formatter};
