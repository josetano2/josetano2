        ...
        for (this.currentIndex = 0; this.currentIndex < this.inputLen; this.currentIndex += 1) {
            ...
            if (this.cur != null) {
                if (this.cur === 'f' && this.next == 'n') {
                    if (stringUtilities_1.StringUtilities.ctypePunct(this.prev) || stringUtilities_1.StringUtilities.ctypeSpace(this.prev) || this.prev == null) {
                        this.currentContent.push(this.cur);
...
exports.SyntaxReflow = SyntaxReflow;
SyntaxReflow.instance = new SyntaxReflow();
//# sourceMappingURL=syntaxReflow.js.map