...
export declare class BladeDocument {
    private documentParser;
    private transformer;
    readonly cursor: DocumentCursor;
    readonly nodes: NodeScanner;
    readonly errors: DocumentErrors;
    static fromText(text: string, seedPosition?: Position | null): BladeDocument;
    static childFromText(text: string, parentParser: DocumentParser, seedPosition?: Position | null): ChildDocument;
    isValid(): boolean;
    transform(): Transformer;
    loadString(text: string): this;
    getLinesAround(line: number): Map<number, string>;
    getContent(): string;
    getOriginalContent(): string;
    getAllNodes(): import("../nodes/nodes").AbstractNode[];
    getRenderNodes(): import("../nodes/nodes").AbstractNode[];
...
//# sourceMappingURL=bladeDocument.d.ts.map