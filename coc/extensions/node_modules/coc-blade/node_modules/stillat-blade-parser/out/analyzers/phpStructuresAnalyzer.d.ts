 ...
 */
export declare class PhpStructuresAnalyzer {
    private parser;
    private structures;
    private hasStructuresWithUnknownLocations;
    private excludedStructures;
    private allowedMethods;
    private phpAssignToGeneric;
    private phpOperatorsToGeneric;
    constructor();
    hasUnknownLocations(): boolean;
    getStructureLocations(code: string, locationOffset: number): void;
    setExcludedStructures(structures: string[]): void;
    setAllowedMethods(methods: string[]): void;
    getStructures(): ILabeledRange[];
    private findStructureLocations;
}
//# sourceMappingURL=phpStructuresAnalyzer.d.ts.map