...
suite('Blade Props', () => {
    test('props are compiled', () => {
        assert_1.default.strictEqual(phpCompiler_1.PhpCompiler.compileString(`@props(['one' => true, 'two' => 'string'])`), `<?php foreach($attributes->onlyProps(['one' => true, 'two' => 'string']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
//# sourceMappingURL=compiler_props.test.js.map