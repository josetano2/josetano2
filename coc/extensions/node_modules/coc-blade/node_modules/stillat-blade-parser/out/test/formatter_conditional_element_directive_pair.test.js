...
suite('Conditional HTML Pair Directive Pairs', () => {
    test('it can indent directive pairs used as HTML elements', () => {
        assert_1.default.strictEqual((0, utils_1.formatBladeString)(`                    <@pair Test @endpair class="something">
    ...
    test('it can indent directives used as HTML elements', () => {
        assert_1.default.strictEqual((0, utils_1.formatBladeString)(`<@directive >
            <div>
                @directive
...
//# sourceMappingURL=formatter_conditional_element_directive_pair.test.js.map