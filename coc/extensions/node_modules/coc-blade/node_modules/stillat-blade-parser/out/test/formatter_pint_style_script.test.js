...
suite('Pint Transformer: Styles and Scripts', () => {
    test('pint: it preserves relative indents when formatting style tags', () => {
        assert_1.default.strictEqual((0, utils_1.formatBladeStringWithPint)(`<html><head>
            @directive($test)
    ...
    test('pint: it can apply relative indent to styles inside structures', () => {
        assert_1.default.strictEqual((0, utils_1.formatBladeStringWithPint)(`<html>
...
//# sourceMappingURL=formatter_pint_style_script.test.js.map