...
suite('Blade Forelse Statements', () => {
    test('forelse statements are compiled', () => {
        assert_1.default.strictEqual(phpCompiler_1.PhpCompiler.compileString(`@forelse ($this->getUsers() as $user)
breeze
@empty
empty
@endforelse`), `<?php $__empty_1 = true; $__currentLoopData = $this->getUsers(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
breeze
...
<?php endif; ?>`);
    ...
    test('forelse statements are compiled with multiple line', () => {
        assert_1.default.strictEqual(phpCompiler_1.PhpCompiler.compileString(`@forelse ([
foo,
bar,
] as $label)
breeze
@empty
empty
@endforelse`), `<?php $__empty_1 = true; $__currentLoopData = [
foo,
bar,
...
//# sourceMappingURL=compiler_forelse.test.js.map